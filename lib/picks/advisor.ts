...
/** Exported for trade analyzer — approximate KTC of a dynasty pick by round/slot */
export function estimateDraftPickKtc(round: number, slot_type: 'early' | 'mid' | 'late'): number {
  return getPickValue(round, slot_type);
}
