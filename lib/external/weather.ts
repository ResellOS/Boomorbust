/** NFL teams whose home venue is a dome / fixed roof (game played indoors when listed as home). */
export const DOME_TEAMS = new Set(['LV', 'NO', 'ATL', 'LAR', 'MIN', 'IND', 'DAL', 'DET', 'ARI']);
