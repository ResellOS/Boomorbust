                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3 mb-4">
                        ...
                        <span
                          className={clsx(
                            'text-[9px] font-black uppercase tracking-wider px-2 py-1 rounded border shrink-0',
                      ...
                      <div className="mt-4 flex items-center justify-between gap-2 flex-wrap">
                        <span
                          className={clsx(
                            'text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded border',
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <span
                        className={clsx(
                          'inline-block mt-1 text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded border',
                          ARCHETYPE_BADGE[row.archetype],
                        )}
                      >
                        {row.archetype}
                  ...
                  <ul className="space-y-2 mb-3">
                    {row.last3.length === 0 ? (
                      ...
                      row.last3.map((t, i) => (
                        <li key={i} className="text-[12px] text-[#94A3B8] leading-snug">
                          <span className="text-[#E2E8F0]">{t.summary}</span>
                          <span className="block text-[11px] text-[#64748B] mt-0.5">{t.valueNote}</span>
                        </li>
                      ))
                    )}
                  </ul>
