...
export default function TrendingAddsTab({ trending, loading }: Props) {
  return (
    <div className="glass-card p-4">
      <h2 className="text-[14px] font-bold text-white tracking-wide mb-4">TRENDING ADDS — LAST 7 DAYS</h2>
            ...
            : trending.map((t) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12px] text-slate-500 uppercase">{t.position} · {t.team}</p>
                </div>
                <span
                  className="text-[15px] font-bold flex-shrink-0 px-3 py-1 rounded-lg"
                  style={{
