  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          <p className="text-[15px] font-bold text-white">{subscription.label}</p>
          ...
          {subscription.renewsLabel && (
            <p className="text-[12px] text-slate-500 mt-0.5">{subscription.renewsLabel}</p>
          )}
        </div>
      </div>
      ...
      {isPaid ? (
        <button
          ...
          className="w-full py-2.5 rounded-xl text-[14px] font-bold transition-all hover:opacity-90 disabled:opacity-60"
