...
export default function ConcentrationRiskTable({ rows }: { rows: ConcentrationRow[] }) {
  if (rows.length === 0) {
    return (
      <div className="mb-4 rounded-lg border border-border bg-surface px-4 py-6 text-center font-mono text-[11px] text-muted">
  ...
  return (
    <section className="mb-4 overflow-x-auto rounded-lg border border-border bg-surface">
      ...
      <table className="w-full min-w-[640px] border-collapse text-left">
        <thead>
          <tr className="border-b border-border font-mono text-[8px] uppercase text-muted">
            ...
            <tr key={r.playerId} className="border-b border-border/40 last:border-b-0">
              <td className="px-3 py-2.5">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <div>
                    <div className="font-mono text-[10px] text-text">{r.fullName}</div>
              ...
              <td className="px-3 py-2.5 font-mono text-[10px] text-text">{r.leagueCount}</td>
              <td className="px-3 py-2.5 font-mono text-[10px] text-boom">{r.portfolioPct}%</td>
              <td className="px-3 py-2.5">
