  ...
  return (
    <footer style={{ background: LANDING.bg }}>
      <div className="mx-auto max-w-[1280px] px-4 py-10 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 font-figtree text-[12px] text-[#e8ecf4]/50">
        ...
        <p className="mt-4 text-center font-figtree text-[11px] text-[#e8ecf4]/40">
          © 2026 SaaSylum. All rights reserved.
        </p>
        <p className="mx-auto mt-3 max-w-xl text-center font-figtree text-[10px] leading-relaxed text-[#e8ecf4]/35">
