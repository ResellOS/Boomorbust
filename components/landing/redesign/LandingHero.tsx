...
function HeroBriefingCard() {
  ...
  return (
    ...
    >
      <span className="absolute right-3 top-3 font-mono text-[9px] uppercase tracking-wider text-[#e8ecf4]/20">
        Example
      </span>
      <div className="border-b px-4 py-3" style={{ borderColor: LANDING.border }}>
        <p className="font-figtree text-[14px] text-[#e8ecf4]">Good morning, Champion.</p>
        <p className="font-figtree text-[13px] text-[#e8ecf4]/60">
      ...
      <div className="grid md:grid-cols-[1fr_140px]">
        <div className="border-r p-3" style={{ borderColor: LANDING.border }}>
          <div className="mb-2 font-mono text-[9px] uppercase tracking-[1.5px] text-[#e8ecf4]/45">
            Today&apos;s Top Actions
          </div>
          <div className="space-y-1.5">
            {HERO_ROWS.map((row) => {
              ...
              return (
                ...
                >
                  <span
                    className="w-12 shrink-0 rounded px-1 py-0.5 text-center font-mono text-[9px] uppercase"
                    style={{ background: style.bg, color: style.text }}
                  >
                    {row.label}
                  </span>
                  <span className="min-w-0 flex-1 truncate font-figtree text-[13px] text-[#e8ecf4]">
                    {row.player}
                  </span>
                  <span className="hidden shrink-0 font-mono text-[10px] text-[#e8ecf4]/45 sm:inline">
                    {row.meta}
                  </span>
                  {row.score != null && (
                    <span className="font-mono text-[12px] tabular-nums text-[#36E7A1]">{row.score}</span>
                  )}
                </div>
              );
            })}
        ...
        <div className="space-y-3 p-3">
          <div>
            <div className="font-mono text-[9px] uppercase tracking-wide text-[#e8ecf4]/45">Portfolio Health</div>
            <div className="mt-1 font-mono text-[22px] tabular-nums text-[#36E7A1]">A-</div>
            <div className="font-mono text-[10px] text-[#36E7A1]">+6.1% vs last week</div>
          </div>
          <div>
            <div className="font-mono text-[9px] uppercase tracking-wide text-[#e8ecf4]/45">Biggest Edge</div>
            <div className="mt-1 font-figtree text-[11px] leading-snug text-[#e8ecf4]/75">
              Your WR depth <span className="font-mono text-[#36E7A1]">+18.4%</span>
            </div>
          </div>
          <div>
            <div className="font-mono text-[9px] uppercase tracking-wide text-[#EF4444]/80">Risk Alert</div>
            <div className="mt-1 font-figtree text-[11px] leading-snug text-[#EF4444]/90">
    ...
    <section className="relative min-h-screen pt-[64px]">
      ...
      <div className="relative mx-auto grid max-w-[1280px] gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-12 lg:px-8 lg:py-24">
        <div>
          ...
          <p className="mt-5 max-w-lg font-figtree text-[16px] leading-relaxed text-[#e8ecf4]/55">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/onboarding"
              className="rounded-md px-5 py-3 font-figtree text-[15px] text-[#0a0d14] transition hover:brightness-110"
            ...
            <Link
              href="#features"
              className="rounded-md border px-5 py-3 font-figtree text-[15px] text-[#e8ecf4]/85 transition hover:border-[#36E7A1]/35"
          ...
          <ul className="mt-8 space-y-2">
            {[
              ...
              <li key={t} className="flex items-center gap-2 font-figtree text-[14px] text-[#e8ecf4]/65">
