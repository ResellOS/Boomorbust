      ...
      <div className="space-y-4 px-4 py-4">
        <section className="space-y-3">
          {METHODOLOGY_POINTS.map((point) => (
            <div key={point.title}>
              <h3 className="font-figtree text-[12px] font-bold text-text">
                {point.title}
              </h3>
        ...
        <p className="font-figtree text-[11px] leading-relaxed text-muted italic">
          {METHODOLOGY_CLOSING}
        </p>

        <section className="rounded-[8px] border border-border bg-bg/50 p-3">
          <div className="font-figtree text-[10px] font-bold uppercase tracking-wide text-muted">
            Season Tracker
          </div>
          <div className="mt-2 font-mono text-[13px] tabular-nums text-text">
