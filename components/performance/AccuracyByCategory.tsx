    ...
    <section className="mb-6">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="rounded-[10px] border border-border bg-surface/40 p-4">
          <div className="mb-2 font-figtree text-[10px] font-semibold uppercase tracking-wide text-muted">
            Buy / Sell Calls
          </div>
          <div className="space-y-1 font-figtree text-[12px] text-muted">
        ...
        <div className="rounded-[10px] border border-border bg-surface/40 p-4">
          ...
          <div className="flex flex-wrap gap-x-3 gap-y-1 font-figtree text-[12px] text-muted">
      ...
      <div className="mt-3 overflow-hidden rounded-[10px] border border-border bg-surface/40">
        <div className="border-b border-border px-3 py-2 font-mono text-[8px] uppercase tracking-wide text-muted">
          Confidence Calibration
        </div>
        <div className="grid grid-cols-[1fr_72px_72px] gap-2 border-b border-border/50 px-3 py-2 font-mono text-[8px] uppercase tracking-wide text-muted">
