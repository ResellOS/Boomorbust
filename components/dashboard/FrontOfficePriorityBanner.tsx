  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <span className="font-mono text-[8px] font-bold uppercase tracking-[1.2px] text-[#f59e0b]">
          ⚡ Priority Action
        </span>
      </div>
      <p className="font-figtree text-[13px] font-semibold leading-snug text-text">
        {priority.playerName} — {verdictLabel} detected
      </p>
      <p className="font-mono text-[10px] text-muted">
        BOB rates market overvalue by +{priority.spotGap} spots
      </p>
      <span className="mt-0.5 font-figtree text-[11px] font-semibold text-[#f59e0b] group-hover:text-[#fbbf24]">
        → View in Trade Hub
      </span>
    </Link>
  );
