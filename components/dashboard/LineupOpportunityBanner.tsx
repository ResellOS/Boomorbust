...
export default function LineupOpportunityBanner({
  ...
  return (
    <div className="flex items-center gap-3 rounded-[8px] border border-boom/40 bg-boom/[0.06] px-3.5 py-2">
      <span className="shrink-0 rounded-[4px] bg-boom/15 px-2 py-1 font-mono text-[9px] font-bold uppercase tracking-[1px] text-boom">
        Biggest Lineup Opportunity
      </span>
      <span className="min-w-0 flex-1 truncate font-figtree text-[13px] text-text">
      ...
      <span className="shrink-0 font-mono text-[15px] font-bold text-boom">+{o.gap.toFixed(1)}</span>
    </div>
  );
}
