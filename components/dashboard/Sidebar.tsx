...
export default function Sidebar({
  ...
  return (
    <aside
      className={`row-start-2 col-start-1 hidden md:flex flex-col overflow-hidden border-r border-border bg-surface transition-[width] duration-200 ${
    ...
    >
      <div className="flex shrink-0 items-center justify-end border-b border-border px-2 py-1.5">
        <button
          type="button"
          onClick={toggle}
          className="rounded-md border border-border bg-surface p-1.5 text-muted transition-colors hover:border-boom/40 hover:text-boom"
