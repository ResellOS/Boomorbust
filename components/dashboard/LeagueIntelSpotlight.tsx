  ...
  if (!data) {
    return (
      <div className="overflow-hidden rounded-[10px] border border-[#1e2640] bg-[#0f1420] px-3 py-3">
        ...
        <p className="mt-1.5 font-mono text-[9px] text-[#6b7a99]">Not enough data yet</p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 px-3 py-2.5">
        <div className="font-figtree text-[13px] font-semibold leading-snug text-[#e8ecf4]">
          {data.managerName}
        ...
        <div>
          ...
          <div className="font-figtree text-[11px] text-[#A78BFA]">{data.archetype}</div>
        </div>
          ...
          <div>
            ...
            <ul className="mt-0.5 space-y-0.5">
              {data.signals.slice(0, 3).map((s, i) => (
                <li key={i} className="font-figtree text-[10px] leading-snug text-[#9aa8c4]">
                  · {s}
                </li>
              ))}
            </ul>
