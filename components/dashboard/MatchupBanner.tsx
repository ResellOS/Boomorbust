    ...
    <section className="glass-panel overflow-hidden !rounded-xl">
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-white/[0.05]">
        <div className="flex items-center gap-4">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 font-mono-tactical tabular-nums">
              WEEK {week} — {totalMatchups} of {totalMatchups} Matchups
            </p>
            <div className="flex items-center gap-2 mt-0.5 font-mono-tactical tabular-nums">
              <span className={`text-2xl font-black ${winning ? 'text-[#36E7A1]' : 'text-white'}`}>
                {myScore.toFixed(1)}
              </span>
              <span className="text-slate-600 text-sm font-bold font-mono-tactical">vs</span>
              <span className="text-2xl font-black text-slate-400">{oppScore.toFixed(1)}</span>
            </div>
          </div>
          <span
            className={`px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-wide border font-mono-tactical ${
              winning
        ...
        <button className="text-[11px] font-semibold text-[#22D3EE] border border-[#22D3EE]/20 rounded-lg px-3 py-1.5 hover:bg-[#22D3EE]/5 transition-colors font-mono-tactical">
          Close to View →
        </button>
      </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 mb-1.5">
                  <span
                    className="text-[9px] font-black px-1.5 py-0.5 rounded font-mono-tactical"
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div
                    className={`flex items-center gap-0.5 px-2.5 py-1.5 rounded-lg font-black text-base ml-2 shrink-0 font-mono-tactical tabular-nums ${
                ...
                <div className="flex items-end justify-between">
                  <div>
                    ...
                    <div className="text-3xl font-black text-white leading-none font-mono-tactical tabular-nums">
                  ...
                  <div className="relative w-11 h-11">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-[9px] font-black text-white font-mono-tactical tabular-nums">{player.confidence}%</span>
                    </div>
                  </div>
                </div>

                <p className="text-[9px] text-slate-600 mt-2 font-mono-tactical">
