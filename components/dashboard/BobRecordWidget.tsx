  ...
  return (
    <div className="shrink-0 overflow-hidden rounded-[10px] border border-[#1e2640] bg-[#0f1420]">
      ...
      <div className="space-y-2 px-3 py-3 font-mono text-[11px]">
        ...
        <p className="border-t border-[#1e2640]/50 pt-2 font-figtree text-[10px] leading-relaxed text-[#6b7a99]">
          Tracking begins Week 1
        </p>
        <p className="font-figtree text-[10px] leading-relaxed text-[#6b7a99]">
          Every call logged publicly
        </p>
        <Link href="/performance" className="block font-mono text-[10px] text-boom no-underline hover:underline">
          View Full Record →
        </Link>
      </div>
    </div>
