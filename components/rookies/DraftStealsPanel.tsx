  ...
  return (
    <div className="glass-card overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.08]">
        <h2 className="text-[12px] font-bold text-white tracking-wide">DRAFT STEALS</h2>
      ...
      <div className="px-4 py-2 border-b border-white/[0.06] grid grid-cols-[16px_1fr_auto_auto_auto] gap-2">
        ...
        <span className="text-[9px] text-slate-500 uppercase tracking-wider">PLAYER</span>
        <span className="text-[9px] text-slate-500 uppercase tracking-wider">RTS vs ADP</span>
        <span className="text-[9px] text-slate-500 uppercase tracking-wider">SLEEPER%</span>
        <span className="text-[9px] text-slate-500 uppercase tracking-wider">IDEAL RANGE</span>
      </div>
      ...
      <div className="divide-y divide-white/[0.04]">
        {loading
          ...
          : steals.map((p, i) => (
            ...
            >
              {/* Rank number */}
              <span className="text-[11px] font-mono font-bold text-slate-500" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                {i + 1}
              </span>
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] uppercase" style={{ color: posColor(p.position) }}>
                  {p.position} · {p.team}
                </p>
              </div>
              ...
              {/* Ideal range */}
              <span className="text-[10px] text-slate-400 font-mono whitespace-nowrap" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                {p.idealRange}
              </span>
            </div>
          ))
