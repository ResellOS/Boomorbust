  ...
  return (
    ...
    >
      <div className="flex h-full items-center gap-2 border-r border-border/40 px-[18px]">
        ...
        <div>
          <div className="font-mono text-[8.5px] uppercase tracking-wide text-muted">Engine Status</div>
          <div className="font-figtree text-sm font-bold text-boom">{footer.engineStatus}</div>
        </div>
        <span className="ml-1.5 font-mono text-[8.5px] text-muted">Last run: 2 min ago</span>
      </div>
      <div className="flex h-full items-center gap-2 border-r border-border/40 px-[18px]">
        <div>
          <div className="font-mono text-[8.5px] uppercase tracking-wide text-muted">
      ...
      <div className="flex h-full items-center gap-2 px-[18px]">
        <div>
          <div className="font-mono text-[8.5px] uppercase tracking-wide text-muted">Trade Volume</div>
          <div className="font-figtree text-sm font-bold text-text">
            {footer.tradeVolumeThisMonth}
          </div>
        </div>
        <span className="ml-1.5 font-mono text-[8.5px] text-muted">This Month</span>
      </div>
    </footer>
  );
}
