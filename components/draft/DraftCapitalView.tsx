  ...
  return (
    <div className="mx-auto flex h-full max-w-[960px] flex-col gap-5 overflow-y-auto px-4 py-6 md:px-6 md:py-8">
      <div>
        ...
        <p className="mt-1 font-figtree text-[12px] text-muted">
          ...
          {groups.map((league) => (
            ...
            >
              <header className="border-b border-border bg-bg/80 px-4 py-2.5">
                <h3 className="font-figtree text-[13px] font-bold uppercase tracking-[1px] text-text">
                  {league.leagueName}
                </h3>
              </header>
              ...
              <div className="flex flex-col gap-4 px-4 py-3">
                {league.seasons.map((seasonGroup) => (
                  <div key={seasonGroup.season}>
                    <div className="mb-2 font-mono text-[10px] font-semibold uppercase tracking-[1.5px] text-muted">
                      {seasonGroup.season}
                    </div>
                        ...
                        <div key={`${seasonGroup.season}-${round}`}>
                          ...
                          <ul className="flex flex-col gap-1.5">
                            {picks.map((pick) => (
                              ...
                              >
                                <span
                                  className="font-figtree text-[12px] font-semibold"
...
function StatCell({
  ...
  return (
    <div className="rounded-[8px] border border-border bg-surface/60 px-3 py-2.5">
      <div className="font-mono text-[8px] uppercase tracking-[1.2px] text-muted">{label}</div>
      <div
